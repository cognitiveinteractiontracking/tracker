...
ELSE (MSVC)
  ...
  #   NO_DEFAULT_PATH
  # )
  FIND_LIBRARY(ARTOOLKIT_AR2_LIBRARY NAMES libAR2.a
    PATHS
    $ENV{EXTERNLIBS}/ARToolKit/lib
    $ENV{ARTOOLKIT5_ROOT}/lib
    NO_DEFAULT_PATH
  ...
  FIND_LIBRARY(ARTOOLKIT_ARGSUBLITE_LIBRARY NAMES libARgsub_lite.a
    PATHS
    $ENV{ARTOOLKIT5_ROOT}/lib
    $ENV{EXTERNLIBS}/ARToolKit/lib
    NO_DEFAULT_PATH
  ...
  FIND_LIBRARY(ARTOOLKIT_ARMULTI_LIBRARY NAMES libARMulti.a
    PATHS
    $ENV{ARTOOLKIT5_ROOT}/lib
    $ENV{EXTERNLIBS}/ARToolKit/lib
    NO_DEFAULT_PATH
  )
  FIND_LIBRARY(ARTOOLKIT_ARUTIL_LIBRARY NAMES libARUtil.a
    PATHS
    $ENV{ARTOOLKIT5_ROOT}/lib
    $ENV{EXTERNLIBS}/ARToolKit/lib
    NO_DEFAULT_PATH
  ...
  FIND_LIBRARY(ARTOOLKIT_EDEN_LIBRARY NAMES libEden.a
    PATHS
    $ENV{ARTOOLKIT5_ROOT}/lib
    $ENV{EXTERNLIBS}/ARToolKit/lib
    NO_DEFAULT_PATH
  )
  FIND_LIBRARY(ARTOOLKIT_KPM_LIBRARY NAMES libKPM.a
    PATHS
    $ENV{ARTOOLKIT5_ROOT}/lib
    $ENV{EXTERNLIBS}/ARToolKit/lib
    NO_DEFAULT_PATH
  ...
  MARK_AS_ADVANCED(
     ...
     ARTOOLKIT_AR2_LIBRARY
     ARTOOLKIT_ARGSUB_LIBRARY
     ARTOOLKIT_ARGSUBLITE_LIBRARY
     ARTOOLKIT_ARICP_LIBRARY
     ARTOOLKIT_ARMULTI_LIBRARY
     ARTOOLKIT_ARUTIL_LIBRARY
     ARTOOLKIT_ARVIDEO_LIBRARY
     ARTOOLKIT_EDEN_LIBRARY
     ARTOOLKIT_KPM_LIBRARY
     )
...
ELSE(MSVC)
  ...
  ELSE(ARTOOLKIT_LIBRARY)
    FIND_PACKAGE_HANDLE_STANDARD_ARGS(ARTOOLKIT DEFAULT_MSG ARTOOLKIT_AR_LIBRARY
      ARTOOLKIT_AR2_LIBRARY ARTOOLKIT_ARGSUB_LIBRARY ARTOOLKIT_ARGSUBLITE_LIBRARY
      ARTOOLKIT_ARICP_LIBRARY ARTOOLKIT_ARMULTI_LIBRARY ARTOOLKIT_ARUTIL_LIBRARY
      ARTOOLKIT_ARVIDEO_LIBRARY ARTOOLKIT_EDEN_LIBRARY ARTOOLKIT_KPM_LIBRARY
